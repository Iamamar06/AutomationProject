...
public class LoginAPITestFromCSVFileData {
	...
	@Test(description = "Verify if login api runs successfully", groups = { "E2E", "Smoke", "Sanity" }, priority = 1, retryAnalyzer = com.utils.MyRetryAnalyzer.class, dataProviderClass = com.dataProvider.LoginDataProvider.class, dataProvider = "Login data on CSV file")
